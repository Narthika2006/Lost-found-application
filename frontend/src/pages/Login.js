    ...
    <div className="page-shell">
      <div className="grid min-h-[78vh] gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <section className="glass-panel rounded-[32px] p-8 md:p-10">
          ...
          <h1 className="mt-6 text-4xl font-semibold md:text-5xl">Welcome back.</h1>
          <p className="mt-4 max-w-xl text-base leading-7 text-slate-300">
            Sign in to manage reports, monitor smart matches, and follow recovery activity with a cleaner dark dashboard.
          </p>

          <div className="mt-8 grid gap-3">
            {[
              "Track lost and found reports in one place.",
              "Review claim progress with clearer status states.",
              "Access location hotspots and live notifications.",
            ].map((item) => (
              <div
                key={item}
        ...
        <Card className="p-2">
          <CardHeader>
            ...
            <p className="mt-2 text-sm text-slate-400">Use your campus account to continue.</p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="grid gap-5">
              ...
              <div className="flex flex-wrap justify-between gap-3 pt-3 text-sm text-slate-400">
                <Link className="font-semibold text-slate-100" to="/register">
                  Create an account
                </Link>
